...
## Exercise Form Demonstration Images (2026-02-17)
- [x] Generate form demonstration illustrations for top 12 preset exercises
- [x] Create exerciseIllustrations.ts mapping file
- [x] Update ExerciseCard component to include illustration section
- [x] Implement responsive layout (side-by-side desktop, stacked mobile)
- [x] Add category badge to exercise cards
- [x] Use light theme color palette from website
