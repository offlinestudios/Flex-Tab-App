...
## Replace Athlete Images with Black Male Representation (2026-02-08)
- [x] Generate new banner image featuring Black male athlete (clean-shaven, great jawline, flat bench press)
- [x] Generate new CTA section image featuring Black male athlete (clean-shaven, great jawline, flat bench press)
- [x] Upload both images to S3 for CDN hosting
- [x] Update Landing.tsx with new image URLs (banner: VdbxnisdsuIpppPZ.jpg, CTA: HglEymMLHGubKOtd.jpg)
- [x] Ensure consistent dark overlay effect (rgba 0,0,0,0.5 for banner, rgba 0,0,0,0.6 for CTA)
- [x] Maintain professional, fitness-focused aesthetic with strong defined jawline
