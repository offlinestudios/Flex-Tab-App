...
async function startServer() {
  ...
  console.log('[Server] =========================');
  console.log('[Server] R2 CONFIGURATION');
  console.log('[Server] =========================');
  console.log('[Server] R2_ACCOUNT_ID:', process.env.R2_ACCOUNT_ID ? 'Set (' + process.env.R2_ACCOUNT_ID.slice(0, 6) + '...)' : 'MISSING');
  console.log('[Server] R2_ACCESS_KEY_ID:', process.env.R2_ACCESS_KEY_ID ? 'Set' : 'MISSING');
  console.log('[Server] R2_SECRET_ACCESS_KEY:', process.env.R2_SECRET_ACCESS_KEY ? 'Set' : 'MISSING');
