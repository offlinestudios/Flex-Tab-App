        ...
        >
          <button
            ...
            style={{
              ...
              background: "var(--exercise-icon-bg)", border: "none",
              cursor: "pointer", display: "flex", alignItems: "center",
              justifyContent: "center", flexShrink: 0,
              color: "var(--exercise-icon-color)",
            }}
          >
          ...
          <div style={{ flex: 1, position: "relative" }}>
            <svg
              ...
              width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--muted-foreground)" strokeWidth="2" strokeLinecap="round"
            >
          ...
          {filters.map((f) => (
            <button
              ...
              style={{
                ...
                fontWeight: 600,
                cursor: "pointer",
                background: activeFilter === f ? "var(--foreground)" : "var(--exercise-icon-bg)",
            ...
            Object.keys(grouped).map((part) => (
              <div key={part}>
                ...
                <div style={{ padding: "14px 16px 6px", display: "flex", alignItems: "center", gap: 8 }}>
                  <div style={{
                    width: 28, height: 28, background: "var(--exercise-icon-bg)",
                ...
                {grouped[part].map((ex) => {
                  ...
                  return (
                    <div
                      ...
                      onMouseEnter={(e) => (e.currentTarget.style.background = "var(--exercise-icon-bg)")}
                      onMouseLeave={(e) => (e.currentTarget.style.background = "transparent")}
                    >
                      {/* Icon tile — always uses the distinct dark tile background */}
                      <div style={{
                        width: 40, height: 40, borderRadius: 12,
                        background: "var(--exercise-icon-bg)", display: "flex",
                      ...
                      {isAdded ? (
                        ...
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--muted-foreground)" strokeWidth="2" strokeLinecap="round" style={{ flexShrink: 0 }}>
          ...
          >
            <button
              ...
              style={{
                ...
                border: "none", background: "var(--exercise-icon-bg)",
                fontSize: 15, fontWeight: 700, color: "var(--exercise-icon-color)",
