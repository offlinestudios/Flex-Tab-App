          ...
          <div style={{ padding: '18px 18px 14px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 16 }}>
              <div style={{ position: 'relative', flexShrink: 0 }}>
                ...
                {/* Camera badge — edit/upload indicator */}
                <button
                  onClick={() => avatarUrl ? setShowAvatarActionSheet(true) : avatarFileInputRef.current?.click()}
                  disabled={avatarUploading}
                  style={{
                ...
                >
                  {/* Camera icon */}
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="var(--background)" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
